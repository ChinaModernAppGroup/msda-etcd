...
function msdaetcdEnforceConfiguredAuditProcessor() {
    ...
    logger.info("loading msdaetcd Enforce Configured Audit Processor");
}
...
msdaetcdEnforceConfiguredAuditProcessor.prototype.WORKER_URI_PATH = "shared/iapp/processors/msdaetcdEnforceConfiguredAudit";

msdaetcdEnforceConfiguredAuditProcessor.prototype.onStart = function (success) {
    logger.fine("msdaetcdEnforceConfiguredAuditProcessor.prototype.onStart");
    //logger.fine("MSDA etcd audit onStart: ConfigProcessor polling state: ");
...
msdaetcdEnforceConfiguredAuditProcessor.prototype.onPost = function (restOperation) {
    entryCounter++;
...
msdaetcdEnforceConfiguredAuditProcessor.prototype.finishOperation = function( restOperation, auditTaskState ) {
    restOperation.setBody(auditTaskState);
    this.completeRestOperation(restOperation);
    logger.fine(getLogHeader() + "DONE" );
};

module.exports = msdaetcdEnforceConfiguredAuditProcessor;
